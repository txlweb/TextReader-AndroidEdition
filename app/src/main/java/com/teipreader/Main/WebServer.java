...
public class WebServer extends Thread implements Main {
    ...
    public static int crash_cheek = 1000;
...
class RequestHandler implements Runnable {
    ...
    public void run() {
        try {
            ...
            if(!(client.getRemoteSocketAddress().toString().contains("127.0.0.1") || client.getRemoteSocketAddress().toString().contains("::1")) && Fire_Wall){
